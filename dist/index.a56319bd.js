...
var _iconCrossSvg = require("../../static/icon-cross.svg");
var _iconCrossSvgDefault = parcelHelpers.interopDefault(_iconCrossSvg);
var _iconCheckSvg = require("../../static/icon-check.svg");
...
if (localStorage.getItem("savedTodos")) savedTodos.map((task)=>{
    ...
    let loadTodo = `<div id=${todoTask.id} class="todo-item ${todoTask.isCompleted ? "completed" : ""}" data-status=${todoTask.isCompleted ? "completed" : "incomplete"}>
            <div class="add-todo-wrapper">
                <div class="add-todo ${todoTask.isCompleted ? "checked" : ""}">
                    <img class="icon-check" src=${(0, _iconCheckSvgDefault.default)} alt="Checked icon" width="11px" height="9px">
                    <span class="white-background"></span>
                </div>
            </div>
            <div class="text-clear-wrapper">
                <p class="todo-text">${todoTask.taskName}</p>
                <img class="icon-clear" src=${(0, _iconCrossSvgDefault.default)} alt="clear icon" width="18px" height="18px">
            </div>
        </div>`;
...
function clickedOnItem(e) {
    ...
    if (targetClicked.classList.contains("add-todo")) {
        ...
        if (targetClicked.closest(".todo-item").getAttribute("data-status") === "incomplete") targetClicked.closest(".todo-item").setAttribute("data-status", "complete");
        else targetClicked.closest(".todo-item").setAttribute("data-status", "incomplete");
    }
...
function showInformationWrapper() {
    ...
    } else informationWrapper.classList.add("hide");
}
...
function showActiveTodos() {
    ...
    activeTodos.forEach((element)=>{
        if (element.classList.contains("completed")) element.classList.add("hide");
...
function showCompletedTodos() {
    ...
    completedTodos.forEach((element)=>{
        if (element.classList.contains("completed")) element.classList.remove("hide");
...
},{"../../static/icon-cross.svg":"6QOXI","../../static/icon-check.svg":"e4XQ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6QOXI":[function(require,module,exports) {
module.exports = require("e1b22b9b0aceceed").getBundleURL("hO9Nr") + "icon-cross.2bfb2999.svg" + "?" + Date.now();

},{"e1b22b9b0aceceed":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"e4XQ9":[function(require,module,exports) {
module.exports = require("5657b526fb2a6f7d").getBundleURL("hO9Nr") + "icon-check.7ac06186.svg" + "?" + Date.now();

},{"5657b526fb2a6f7d":"lgJ39"}],"gkKU3":[function(require,module,exports) {
...
},{}]},["cu6sN","bAabt"], "bAabt", "parcelRequire94c2")
